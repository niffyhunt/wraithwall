# PUBLISH-001 — Canonical draft synced from v1.1 source

**STATUS:** EDITORIAL_REVIEW — see `PUBLICATION_PREVIEW.md` for approval.  
**Canonical source:** `docs/knowledge-pipeline/articles/linux-incident-response-checklist/source.md`  
**Formats:** `website.md`, `medium.md`, `pastebin.txt` in same directory.
